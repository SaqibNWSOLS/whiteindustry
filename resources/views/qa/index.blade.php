...
<div class="content">
        ...
        <div class="col-md-6 col-lg-3 mb-3">
            <div class="card h-100">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        <h6 class="card-title mb-1">Total QA Quotes</h6>
                        <div class="h4 fw-bold">{{ $stats['total'] }}</div>
                        <small class="text-muted">All QA quotes</small>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card h-100">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <small class="text-muted">Awaiting QA review</small>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card h-100">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <small class="text-muted">Currently in QA</small>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card h-100">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <small class="text-muted">QA approved</small>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card h-100">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <small class="text-muted">QA rejected</small>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card h-100">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <small class="text-muted">Quotes with QA files</small>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title mb-0">QA Quotations Pending Review</h3>
        </div>
        <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('orders.show', $qa->orders_id) }}" class="btn btn-sm btn-outline-secondary" title="View Order">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('qa.show', $qa->id) }}" class="btn btn-sm btn-outline-primary" title="QA Review">
